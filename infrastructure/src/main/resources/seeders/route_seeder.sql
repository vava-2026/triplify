...
INSERT INTO tmp_seed_routes (
    ...
    ('Spain Inland Culture Route', 'Spain', 11, 17, 'An inland-focused circuit that combines fortress viewpoints, heritage streets, and quieter cultural districts beyond the busiest coasts. Travel windows are practical, giving flexibility for queues, weather, or local events.'),
    ...
    ('Germany Forest Edge Itinerary', 'Germany', 11, 16, 'This line explores forest-edge regions and historic districts where nature viewpoints and city heritage overlap. The pacing supports relaxed mornings and late-day exploration without forcing tight timing windows.'),
