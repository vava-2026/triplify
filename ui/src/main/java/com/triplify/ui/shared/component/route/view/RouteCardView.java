...
public class RouteCardView implements Initializable {
    ...
    private static final double DETAILS_CARD_WIDTH = 257.0;
    private static final double DETAILS_CARD_HEIGHT = 353.0;
    private static final double DETAILS_IMAGE_HEIGHT = 184.0;
    ...
    public void setOnOpen(Runnable onOpen) {
        this.onOpen = onOpen;
        root.setCursor(onOpen == null ? Cursor.DEFAULT : Cursor.HAND);
    }
    ...
    private String formatPlacesCount(int placesCount) {
        return placesCount == 1 ? "1 place" : placesCount + " places";
    }

    private String formatDistance(double distance) {
        return String.format(Locale.US, "%.1f kilometers", distance);
    }
}
