...
public class AppSelectViewModel<T> {
    ...
    public void setPlaceholder(String v)                     { placeholder.set(v); }
    ...
    public ObjectProperty<SelectEntry<T>> selectedItemProperty() { return selectedItem; }
    public SelectEntry<T> getSelectedItem()                  { return selectedItem.get(); }
    public void setSelectedItem(SelectEntry<T> v)            { selectedItem.set(v); }

    public ListProperty<SelectEntry<T>> itemsProperty()      { return items; }
    public ObservableList<SelectEntry<T>> getItems()         { return items.get(); }
    public void setItems(ObservableList<SelectEntry<T>> v)   { items.set(v); }

    public ObjectProperty<SelectVariant> variantProperty()   { return variant; }
    public SelectVariant getVariant()                        { return variant.get(); }
    public void setVariant(SelectVariant v)                  { variant.set(v); }

    public void setOnSelect(java.util.function.Consumer<SelectEntry<T>> r) { this.onSelect = r; }
